export default function BlogSection() {
    const IMAGES = [ 
        {   
            ...
            title:"stuff1",
            date: "Jan 19, 2021",
            description1:"Today’s best design",
            description2:"trends for digital",
            description3:"products",
        },
        {
            img_url:"stuff2.png",
            title:"stuff2",
            date: "Jan 19, 2021",
            description1:"A practical guide to",
            description2:"building a brand ",
            description3:"strategy",
        }
    ];
    ...
    return (
        <section className="bg-[#ECF8F9] py-24">
            <div className="main-container">
                <div className="bg-[#666DFF] h-4 w-4"></div>
                <h4 className="heading mt-4.75 mb-12">Read our latest blogs & news</h4>
                ...
                <div className="flex justify-between">
                    ...
                    <div className="flex">
                        ...
                        <div className="bg-[#FFFFFF] p-8">
                            <span className="font-medium text-[14px] leading-5 text-[#232536]">{img.date}</span>
                            <h3 className="font-semibold text-2xl leading-9 text-[#232536] mt-2 mb-5">{img.description1}<br />{img.description2}<br />{img.description3}</h3>
                            
                    <h4 className="flex items-center gap-3.5 font-medium leading-6 text-[#444CFC] cursor-pointer">Read More
